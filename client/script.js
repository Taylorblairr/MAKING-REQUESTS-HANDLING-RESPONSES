...
*/
    ...
    // function repeatEl() {
    //     return axios.get('http://localhost:3000/repeat/Why-will-this-not-work')
    //     .then(res => res.data) 
...
// CODE HERE
const send = () => {
    return axios.get('http://localhost:3000/query-test')
    .then(res => {
        console.log(res.data)
...
document.getElementById('query-button').addEventListener('click', send)
